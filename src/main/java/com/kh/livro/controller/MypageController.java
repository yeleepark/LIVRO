...
public class MypageController {
	...
	public String profileUpload(HttpServletRequest request, Model model, ProfileDto profiledto, String member_id) {
		...
		// 데이터 저장
		profileBiz.profileInsert(member_id);
		...
		String profile_savedname = uuid + profile.getOriginalFilename();
		...
		profileObj.setProfile_savedname(profile_savedname); // 서버에 저장할 이름 넣고
		profileObj.setProfile_realname(profile_realname); // 실제 이름을 넣고
