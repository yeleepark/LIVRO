...
//state: 애플리케이션이 생성한 상태 토큰
   private final static String CLIENT_ID = "sJFk9OHc0ap2kOMNHBrt";
   private final static String CLIENT_SECRET = "PVr2FiGl3e";
   private final static String REDIRECT_URI = "http://localhost:8787/livro/callback.do";
   ...
   public String getUserProfile(OAuth2AccessToken oauthToken)
       ...
       * .apiSecret(CLIENT_SECRET) .callback(REDIRECT_URI)
       * .build(LoginNaverApi.instance()); OAuthRequest request = new
       * OAuthRequest(Verb.GET, PROFILE_API_URL, oauthService);
       * oauthService.signRequest(oauthToken, request); Response response =
