...
CREATE TABLE FOLLOWER(
	...
	CONSTRAINT FOLLOWER_MEM_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER(MEMBER_ID),
	CONSTRAINT FOLLOWER_MEM_NICK_FK FOREIGN KEY(MEMBER_NICKNAME) REFERENCES MEMBER(MEMBER_NICKNAME),
	CONSTRAINT FOLLOWER_ID_FK FOREIGN KEY(FOLLOWER_ID) REFERENCES MEMBER(MEMBER_ID),
	CONSTRAINT FOLLOW_NICK_FK FOREIGN KEY(FOLLOWER_NICKNAME) REFERENCES MEMBER(MEMBER_NICKNAME)
);
...
-- 제약조건 재 수정을 위한 삭제
ALTER TABLE FOLLOWER DROP CONSTRAINT FOLLOWER_ID_FK
-- 제약조건 수정 
ALTER TABLE FOLLOWER ADD CONSTRAINT FOLLOWER_MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER(MEMBER_ID) ON DELETE CASCADE
-- 제약조건 재 수정을 위한 삭제
ALTER TABLE FOLLOWER DROP CONSTRAINT FOLLOWER_NICK_FK
-- 제약조건 수정 
ALTER TABLE FOLLOWER ADD CONSTRAINT FOLLOWER_NICK_FK FOREIGN KEY(MEMBER_NICKNAME) REFERENCES MEMBER(MEMBER_NICKNAME) ON DELETE CASCADE
