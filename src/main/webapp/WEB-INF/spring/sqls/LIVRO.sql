...
CREATE TABLE BROADCAST(
	...
	--방송여부
	BROADCAST_FLAG CHAR(1) CHECK(BROADCAST_FLAG IN('Y', 'N')),
	--방송시작시간
	BROADCAST_STARTDATE DATE NOT NULL,
	--방송종료시간
	BROADCAST_ENDDATE DATE NULL,

	CONSTRAINT BROADCAST_MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER(MEMBER_ID)
);       
 
INSERT INTO BROADCAST
VALUES(BROADCAST_NO_SEQ.NEXTVAL, 'artist', '썸네일', '방송테스트1', '방송테스트 설명입니다','카테고리', SYSDATE, NULL);
