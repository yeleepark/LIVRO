...
CREATE TABLE PROFILE(
	...
	PROFILE_SAVEDNAME VARCHAR2(260),
	PROFILE_REALNAME VARCHAR2(36),
	PROFILE_REGDATE DATE DEFAULT SYSDATE,
	PROFILE_DELFLAG VARCHAR2(1) DEFAULT 'N',
	
	CONSTRAINT PROFILE_MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER(MEMBER_ID),
	CONSTRAINT PROFILE_MEMBER_NK_FK FOREIGN KEY(MEMBER_NICKNAME) REFERENCES MEMBER(MEMBER_NICKNAME),
...
CREATE TABLE MUSIC(	
	...
	CONSTRAINT MUSIC_MEMBER_NICKNAME_FK FOREIGN KEY(MEMBER_NICKNAME) REFERENCES MEMBER(MEMBER_NICKNAME)
);
