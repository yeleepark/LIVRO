...
--프로필 테이블
DROP SEQUENCE PROFILE_SEQ_NO;
CREATE SEQUENCE PROFILE_SEQ_NO
START WITH 1
INCREMENT BY 1
NOMAXVALUE NOCACHE;
...
CREATE TABLE PROFILE(
	...
	MEMBER_ID VARCHAR2(20) NOT NULL,
	PROFILE_SAVEDNAME VARCHAR2(260) NOT NULL,
	PROFILE_REALNAME VARCHAR2(36) NOT NULL,
	PROFILE_SIZE NUMBER NOT NULL,
	PROFILE_REGDATE DATE DEFAULT SYSDATE NOT NULL,
	PROFILE_DELFLAG VARCHAR2(1) DEFAULT 'N' NOT NULL,
	
	CONSTRAINT MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER(MEMBER_ID),
	CONSTRAINT PROFILE_DELFLAG_CHK CHECK(PROFILE_DELFLAG IN('Y', 'N'))
);
...
CREATE TABLE MUSIC(
	...
	--음원
	MUSIC_FILE VARCHAR2(1000) NOT NULL,
	--날짜
	MUSIC_DATE DATE NOT NULL
);

ALTER TABLE MUSIC 
ADD CONSTRAINT MUSIC_MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER(MEMBER_ID);
...
CREATE TABLE BROADCAST(
	...
	--썸네일
	MEMBER_PROFILE VARCHAR2(1000) NOT NULL,

	CONSTRAINT BROADCAST_MEMBER_NICKNAME_FK FOREIGN KEY(MEMBER_NICKNAME) REFERENCES MEMBER(MEMBER_NICKNAME),
	CONSTRAINT BROADCAST_MEMBER_PROFILE_FK FOREIGN KEY(MEMBER_PROFILE) REFERENCES MEMBER(MEMBER_PROFILE)
