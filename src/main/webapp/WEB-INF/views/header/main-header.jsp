...
<body>
	<header role="header" id="header">
		...
		<div class="header-bar header-center">
			<c:if test="${logindto.member_role == 'A' }">
				<img src="resources/img/livro_icon.png" title="나의 아티스트 페이지로 이동" onclick="location.href='artist.do?member_id=${logindto.member_id }'">
			</c:if>
	...
	<c:forEach items="${calList }" var="list">
		<input type="hidden" value="${list.member_id }">		
		<input type="hidden" value="${list.cal_start }">
	</c:forEach>
