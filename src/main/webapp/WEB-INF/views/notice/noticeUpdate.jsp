...
<div class="notice_update_wrap">
	...
	<div >
		...
		<c:if test="${logindto.member_role eq 'M'}">
			<input type="submit" class="noticeBtn" value="수정" onclick="formSubmit()">
		</c:if>	
			<input type="button" class="noticeBtn" value="취소" onclick="location.href='detail.do?notice_no=${dto.notice_no}'">
		</div>
	</div>
	</form>
</div>
